                        ...
                        <div className="cart-table">
                            {
                                ...
                                </table> : <Col lg="12 text-center">
                                        <img src={emptyCartSvg} alt="empty cart" style={{ maxHeight: '200px', maxWidth: '200px' }} />
                                        <p className="text-primary mt-4">Your shopping cart is empty.</p>
                                </Col>
                            }
                        </div>
                        <Row>
                                ...
                                <Col lg="4">
                                    ...
                                    <div className="discount-coupon">
                                        ...
                                        <form action="#" className="coupon-form">
                                            <input type="text" className="form-control" placeholder="Enter your coupon code" aria-label="coupon code" />
                                            <button type="button" className="site-btn coupon-btn">Apply</button>
                                        </form>
                                    </div>
                                </Col>
                                <Col lg={{ offset: 4, size: 4 }}>
                                    <div className="proceed-checkout">
                                        <ul style={{ marginInlineStart: "0px" }}>
                                            <li className="subtotal">Subtotal <span>Ksh {props.total}</span></li>
                                            <li className="cart-total">Total <span>Ksh {props.total}</span></li>
                                        </ul>
